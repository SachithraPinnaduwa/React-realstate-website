...
const SearchForm = ({ properties, fetchDat, formData, setFormData }) => {
  // this is the filter component that is used to filter the properties based on the form data
      ...
      >
        ...
        <div className="my-5 md:flex items-center">
          ...
          <input
            type="date"
            id="date"
            className="w-[50%]  rounded-md border border-gray-600 focus:border-primary-500
             focus:ring focus:ring-primary-200 focus:ring-opacity-50 h-10 mt-2 md:mt-0 md:ml-2"
            {...register("date", {
              valueAsDate: true,
            })}
          />
        ...
        <div className="my-5 md:flex items-center md:flex-row">
          <label className="block  font-medium text-black md:mr-auto md:ml-6 text-xl">
            Price
          </label>
          <div>
            <div className=" items-center mt-2 md:mt-0 md:ml-2">
              ...
              <input
                ...
                focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 h-10 mt-2"
                id="pricemin"
                placeholder={errors.pricemin?.message}
            ...
            <div className=" items-center mt-2 md:mt-0 md:ml-2">
              ...
              <input
                ...
                focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 h-10 mt-2"
                id="pricemax"
                placeholder={errors.pricemax?.message}
        ...
        {/* Number of bedrooms */}
        <div className="my-5 md:flex items-center md:flex-row">
          <label className="block text-xl font-medium text-black md:mr-auto md:ml-6">
            Bedrooms
          </label>
          <div>
            <div className=" items-center mt-2 md:mt-0 md:ml-2 ">
              ...
              <input
                ...
                type="number"
                id="bedroomsmin"
                placeholder={errors.bedroomsmin?.message}
            ...
            <div className=" items-center mt-2 md:mt-0 md:ml-2 ">
              ...
              <input
                ...
                type="number"
                id="bedroomsmax"
                placeholder={errors.bedroomsmax?.message}
