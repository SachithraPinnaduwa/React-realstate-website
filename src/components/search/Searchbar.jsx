...
export default function Searchbar({ setResults, results }) {
  ...
  return (
    <div className="py-6 bg-cyan-900 md:min-w-[1000px] sm:min-w-0 mx-auto px-[10%] max-h-[250px] md:min-h-[250px] sm:min-h-0">
      ...
      <div className="flex justify-center ">
        ...
        <div className="sm:my-2 lg:my-0">
          <Link to="/search">
          <button className=" px-4 py-2 rounded-md text-black bg-emerald-500 mx-6 ">
            Search
          </button>
          </Link>
        </div>
