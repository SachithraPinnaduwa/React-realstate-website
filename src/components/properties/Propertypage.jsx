...
export default function Propertypage() {
  ...
  const { handlePressChangeFavourites, pressed, setPressed, setFavouriteProperties, setIds, ids } = useAppContext();
  const { id } = useParams();
            ...
            <div className=" w-full mx-auto">
              ...
              >
                ...
                <button
                  ...
                  className={`relative block h-10 px-6 tab  ${activeTab === 1 ? 'bg-gray-500' : ''
                    }`}
                >
                  Map
                </button>
                <button
                  ...
                  className={`relative block h-10 px-6 tab  ${activeTab === 2 ? 'bg-gray-500' : ''
                    }`}
                >
                  Floor Plan
                </button>
                <button
                  ...
                  className={`relative block h-10 px-6 tab  ${activeTab === 3 ? 'bg-gray-500' : ''
                    }`}
                >
                  Long Description
                </button>
              ...
              <div className="mt-6 relative  bg-purple-50">
                ...
                <div
                  ...
                  className={`tab-panel p-6 min-h-[70vh] transition duration-300 ${activeTab === 1 ? '' : 'hidden'
                    }`}
                >
                  <MapContainer
                ...
                <div
                  ...
                  className={`tab-panel p-6 min-h-[70vh]  transition duration-300 ${activeTab === 2 ? '' : 'hidden'
                    }`}
                >
                ...
                <div
                  ...
                  className={`tab-panel p-6 min-h-[70vh] transition duration-300 ${activeTab === 3 ? '' : 'hidden'
                    }`}
                >
